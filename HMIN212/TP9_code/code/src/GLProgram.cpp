...
void GLProgram::setUniformMatrix3fv (GLint location, const float * values) {
    use ();
    glUniformMatrix3fv (location, 1, GL_FALSE, values);
}

void GLProgram::setUniformMatrix3fv (const std::string & name, const float * values) {
    use ();
...
void GLProgram::reload () {
  ...
  void GLProgram::setUniform1fv (GLint location, unsigned int nValues , const float * values){
     glUniform1fv( location , nValues , values );
  }
  void GLProgram::setUniform1fv (const std::string & name, unsigned int nValues , const float * values) {
     setUniform1fv( getUniformLocation (name) , nValues , values );
  }



  void GLProgram::setUniform1iv (GLint location, unsigned int nValues , const int * values){
     glUniform1iv( location , nValues , values );
  }
  void GLProgram::setUniform1iv (const std::string & name, unsigned int nValues , const int * values){
     glUniform1iv( getUniformLocation (name) , nValues , values );
  }



  void GLProgram::setUniform2fv (GLint location, unsigned int nValues , const float * values){
     glUniform2fv( location , nValues , values );
  }
  void GLProgram::setUniform2fv (const std::string & name, unsigned int nValues , const float * values){
     glUniform2fv( getUniformLocation (name) , nValues , values );
  }




  void GLProgram::setUniform2iv (GLint location, unsigned int nValues , const int * values){
     glUniform2iv( location , nValues , values );
  }
  void GLProgram::setUniform2iv (const std::string & name, unsigned int nValues , const int * values){
     glUniform2iv( getUniformLocation (name) , nValues , values );
  }




  void GLProgram::setUniform3fv (GLint location, unsigned int nValues , const float * values){
     glUniform3fv( location , nValues , values );
  }
  void GLProgram::setUniform3fv (const std::string & name, unsigned int nValues , const float * values){
     glUniform3fv( getUniformLocation (name) , nValues , values );
  }




  void GLProgram::setUniform3iv (GLint location, unsigned int nValues , const int * values){
     glUniform3iv( location , nValues , values );
  }
  void GLProgram::setUniform3iv (const std::string & name, unsigned int nValues , const int * values){
     glUniform3iv( getUniformLocation (name) , nValues , values );
  }




  void GLProgram::setUniform4fv (GLint location, unsigned int nValues , const float * values){
     glUniform4fv( location , nValues , values );
  }
  void GLProgram::setUniform4fv (const std::string & name, unsigned int nValues , const float * values){
     glUniform4fv( getUniformLocation (name) , nValues , values );
  }




  void GLProgram::setUniform4iv (GLint location, unsigned int nValues , const int * values){
     glUniform4iv( location , nValues , values );
  }
  void GLProgram::setUniform4iv (const std::string & name, unsigned int nValues , const int * values){
     glUniform4iv( getUniformLocation (name) , nValues , values );
  }
